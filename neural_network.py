...
model = keras.Sequential([
    ...
    keras.layers.Dense(500, activation='linear'),  # hidden layer (2)
    keras.layers.Dense(500, activation='tanh'),  # hidden layer (2)
